package app.bwizlabs.repository;

import app.bwizlabs.GalleryApp;
import app.bwizlabs.config.Constants;
import app.bwizlabs.config.TestSecurityConfiguration;
import app.bwizlabs.config.audit.AuditEventConverter;
import app.bwizlabs.domain.PersistentAuditEvent;
...
import static app.bwizlabs.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
